...
import { useLmsRecorder, ProgressDashboard, summarize, type Learner } from "@faraday-kit/kit/lms";
import { Compare, Lesson, Prose, Quiz } from "@faraday-kit/kit/blocks";
...
export default function LmsCourse() {
  ...
  // summarize() (exported from @faraday-kit/kit/lms) derives the whole LmsSummary — no
