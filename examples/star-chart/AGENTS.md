...
> **Pack `three`:** installed via `faraday pack add three`. Authoring guide at `.faraday/packs/three/pack.md`. Load it when the lesson needs a 3D scene, an orbital/spatial model, or a 3D curriculum world.
